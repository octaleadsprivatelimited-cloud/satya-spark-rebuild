...
export const Route = createFileRoute("/products")({
  head: () => ({
    meta: [
      { title: "Products — Fiber Optic Tools | Satya Power Technologys" },
      { name: "description", content: "Browse fusion splicers, OTDRs, power meters, cleavers, VFLs and toolkits from INNO, VIAVI, EXFO, Grandway and more." },
      { property: "og:title", content: "Fiber Optic Products" },
      { property: "og:description", content: "Genuine fiber optic tools from authorized brands, delivered pan-India." },
    ],
      ...
      <section className="bg-brand text-brand-foreground">
        <div className="container-page py-16 md:py-20">
          ...
          <p className="mt-3 max-w-2xl text-white/85">
            Genuine fiber optic tools from authorized brands. Fusion splicers, OTDRs, power meters,
            cleavers, VFLs and complete toolkits.
          </p>
        </div>
      </section>
        ...
        <div className="container-page">
          ...
          {filtered.length === 0 ? (
            <div className="rounded-lg border border-dashed border-border p-12 text-center text-muted-foreground">
              ...
              <div className="mt-4">
                <Button variant="brandOutline" onClick={() => { setQ(""); setCat("all"); setBrand("all"); }}>
                  Reset filters
                </Button>
              </div>
            </div>
