...
import { refreshCatalog, useCatalog as useProducts } from "@/lib/product-catalog";
...
const REVIEWS = [
  {
    ...
    rating: 5,
    content:
      "We have been purchasing Inno fusion splicers and accessories from Satya Power since 2018. Their pricing is unbeatable, and the service support in Kakinada is exceptionally prompt.",
  },
  {
    name: "Mohammad Ali",
    ...
    rating: 5,
    content:
      "The team resolved a calibration issue on our EXFO OTDR within 24 hours. The repair work is highly professional and they only use genuine components. Strongly recommended!",
  },
  {
    name: "P. Srinivas Rao",
    role: "Proprietor",
    ...
    rating: 5,
    content:
      "Very reliable supplier for fiber equipment in Andhra Pradesh. Bought multiple toolkit sets and cleaning supplies. Best prices and excellent customer service.",
  },
  {
    name: "G. Venkatesh",
    ...
    rating: 5,
    content:
      "Satya Power is our go-to partner for fusion splicer electrode replacement and service. Their technicians are highly knowledgeable and handle calibration perfectly.",
  },
  {
    name: "T. Anil Kumar",
    role: "ISP Partner",
    ...
    rating: 5,
    content:
      "Recently purchased the Grandway optical power meters and laser sources. The products are extremely durable, and the team provided excellent guidance on operation.",
  },
];
      ...
      <div className="mx-auto max-w-[1920px] px-6 md:px-16">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10 md:mb-16">
          <div>
            ...
            <h2 className="text-3xl md:text-5xl font-light text-foreground leading-[1.15]">
        ...
        <div className="mx-auto max-w-[1920px] px-6 md:px-16">
          <div className="grid md:grid-cols-3 gap-6 mb-8 md:gap-10 md:mb-12 items-end">
            <div className="md:col-span-2">
              ...
              <h2 className="text-2xl md:text-5xl font-light text-foreground leading-[1.15]">
                Top picks from our catalogue
              </h2>
            </div>
            <div className="flex md:justify-end items-center gap-3 md:gap-4">
              ...
              <Link
                to="/products"
                className="group inline-flex items-center gap-2 text-sm font-normal text-primary hover:text-brand-red-dark border-b border-primary pb-1"
              >
                View all{" "}
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2 sm:gap-3 md:gap-4">
            {loading &&
              ...
              Array.from({ length: 4 }, (_, i) => (
                <div
                  key={`loading-${i}`}
                  className="h-64 animate-pulse bg-muted border border-border"
                  role="status"
                  aria-label="Loading products"
                />
              ))}
            {error && (
              <div role="alert" className="col-span-full text-sm p-4 border border-border">
                {error}{" "}
                <button
                  type="button"
                  className="underline"
            ...
            {featured.map((p, i) => (
              <ProductCard key={p.id} p={p} idx={i} allProducts={products} />
            ))}
          </div>
        </div>
      </section>
      ...
      <section className="py-14 md:py-24 bg-card text-foreground border-t border-border overflow-hidden">
        <div className="mx-auto max-w-[1920px] px-6 md:px-16 grid lg:grid-cols-2 gap-10 md:gap-16 items-center">
          <div className="space-y-6 md:space-y-8 animate-in fade-in slide-in-from-bottom-5 duration-700">
            <div>
              <div className="text-xs font-semibold text-primary uppercase tracking-wider mb-2">
                New Service Frontier
              </div>
              <h2 className="text-3xl md:text-5xl font-light leading-[1.15] text-foreground">
                Powering the Future:
                <br />
                EV Battery Repair Services
              </h2>
            </div>
            <p className="text-muted-foreground text-base md:text-lg leading-relaxed">
              We have recently expanded our service portfolio to support the transition to electric
              vehicles. For EV batteries, we specifically provide only repair, service, and cell
              replacement.
            </p>
            <div className="space-y-4">
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-md font-medium text-foreground">
                    EV Battery Repair & Service
                  </h3>
                  <p className="text-sm text-muted-foreground">
                    Comprehensive health diagnostics, safety testing, capacity validation, and
                    servicing to restore original battery efficiency.
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Cost-effective replacement of individual degraded or faulty cell modules to
                    extend the lifecycle of your existing pack.
                  </p>
                </div>
              </div>
            </div>
